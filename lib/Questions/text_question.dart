...
class TextQuestionDialog extends StatefulWidget {
  final Question question;

  const TextQuestionDialog({Key? key, required this.question}) : super(key: key);

  @override
  // ignore: no_logic_in_create_state, library_private_types_in_public_api
  _TextQuestionDialogState createState() => _TextQuestionDialogState(question);
}

class _TextQuestionDialogState extends State<TextQuestionDialog> {
  final Question question;

  _TextQuestionDialogState(this.question);
